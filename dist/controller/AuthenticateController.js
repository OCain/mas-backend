...
var AuthenticateController = /** @class */ (function () {
    ...
    AuthenticateController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var authData, authenticaterUser, auth;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authData = request.body;
                        authenticaterUser = new AuthenticateUserService_1.AuthenticateUserService();
                        return [4 /*yield*/, authenticaterUser.execute(authData)];
                    case 1:
                        auth = _a.sent();
